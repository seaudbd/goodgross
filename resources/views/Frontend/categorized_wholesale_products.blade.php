        ...
        function showGridView(products) {
            $.each(products, function (key, product) {
                ...
                $('#products_container').append(
                    ...
                    '<div class="wholesale_product_image pt-2" id="product_' + product.id + '"></div>' +
                    '</div>' +
                ...
                $.each(imagePaths, function (imagePathKey, imagePathValue) {
                    ...
                    $('#product_' + product.id).append('<div><img src="' + imgLoading + '" class="img-fluid rounded product" data-product_id="' + product.id + '" style="cursor: pointer;" data-lazy="' + imgSrc + '" alt="Product Image"></div>');
                });
        ...
        function showListView(products) {
            $.each(products, function (key, product) {
                ...
                $('#products_container').append(
                    ...
                    '<div class="wholesale_product_image" id="product_' + product.id + '"></div>' +
                    '</div>' +
                    '</div>' +
